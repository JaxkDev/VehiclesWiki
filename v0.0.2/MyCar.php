...
class MyCar extends Vehicle {
	...
	{
		$this->driverPosition = new Vector3(0,-0.3,0); //X,Y,Z
		//Repeat the same line above to make multiple passenger seats.
		parent::__construct($level, $nbt);

		$this->setScale(2.5); //If you had to scale down/up while modelling you can set it to real size here.
	}
	...
	{
		return Main::getInstance()->designFactory->getDesign("My-Car-Design");
	}
